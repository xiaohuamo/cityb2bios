...
struct PrivacyPolicyView: View {
    ...
    @State private var PrivacyPolicyContent = ""
    ...
    var body: some View {
           ...
           .navigationBarTitle("隐私协议", displayMode: .inline)
    ...
    private func fetchPrivacyPolicyContent() {
        // 通过 API 获取关于我们的内容
        // 这里仅为示例，未实际获取内容
        PrivacyPolicyContent = """
            ...
            and modified by CityB2b (www.cityb2b.com)
            ...
            personal data type will be deleted after registed 12 months if the account has no activities such as purchasing or publishing .
            ...
            we use Google Analytics and Adwords on our website to recognize a computer when a user visits the website , track users as they navigate the website ,enable the use of a shopping cart on the website ,analyze the use of the website，prevent fraud and improve the security of the website , personalize the website for each user ;
